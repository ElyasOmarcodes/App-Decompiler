...
.method public static findResultByJ(DDD)I
    ...
    .line 583
    invoke-virtual {v2}, Lcom/google/android/material/color/utilities/ViewingConditions;->getN()D
    ...
    .line 585
    invoke-virtual {v2}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNc()D

    move-result-wide v7

    mul-double v3, v3, v7

    invoke-virtual {v2}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNcb()D
    ...
    .line 596
    invoke-virtual {v2}, Lcom/google/android/material/color/utilities/ViewingConditions;->getAw()D

    move-result-wide v11

    .line 597
    invoke-virtual {v2}, Lcom/google/android/material/color/utilities/ViewingConditions;->getC()D
    ...
    invoke-virtual {v2}, Lcom/google/android/material/color/utilities/ViewingConditions;->getZ()D
    ...
    .line 598
    invoke-virtual {v2}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNbb()D
    ...
    const-wide v13, 0x407c300000000000L    # 451.0

    mul-double v13, v13, v5

    add-double/2addr v13, v0

    const-wide/high16 v19, 0x4072000000000000L    # 288.0

    mul-double v19, v19, v11

    add-double v19, v19, v13

    const-wide v13, 0x4095ec0000000000L    # 1403.0

    div-double v19, v19, v13

    const-wide v21, 0x408bd80000000000L    # 891.0

    mul-double v21, v21, v5

    sub-double v21, v0, v21

    const-wide v25, 0x4070500000000000L    # 261.0
    ...
    .line 605
    invoke-static/range {v19 .. v20}, Lcom/google/android/material/color/utilities/HctSolver;->inverseChromaticAdaptation(D)D

    move-result-wide v5

    .line 606
    invoke-static/range {v21 .. v22}, Lcom/google/android/material/color/utilities/HctSolver;->inverseChromaticAdaptation(D)D
    ...
    .line 609
    invoke-static {v13, v0}, Lcom/google/android/material/color/utilities/MathUtils;->matrixMultiply([D[[D)[D
