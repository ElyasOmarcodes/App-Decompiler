...
.method public static constructor <clinit>()V
    ...
    invoke-direct/range {v20 .. v25}, Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholdsGroup;-><init>(Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholds;Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholds;Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholds;Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholds;Lcom/google/android/material/transition/MaterialContainerTransform$1;)V
    ...
    invoke-direct {v15, v1, v2}, Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholds;-><init>(FF)V
    ...
    invoke-direct {v3, v7, v2}, Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholds;-><init>(FF)V

    new-instance v4, Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholds;

    const v5, 0x3e4ccccd    # 0.2f

    invoke-direct {v4, v5, v2}, Lcom/google/android/material/transition/MaterialContainerTransform$ProgressThresholds;-><init>(FF)V
...
.method public static captureValues(Ll/ۜۥ۟;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
    .locals 2
    ...
    .line 815
    iget-object p1, p0, Ll/ۜۥ۟;->۬:Landroid/view/View;
    ...
    .line 822
    iget-object p2, p0, Ll/ۜۥ۟;->۬:Landroid/view/View;

    sget v0, Ll/ۛۚ۟ۥ;->ۚۖ:I
...
.method private maybeApplyThemeValues(Landroid/content/Context;Z)V
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/google/android/material/transition/TransitionUtils;->maybeApplyThemeInterpolator(Ll/ۖۗۜ;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z

    if-eqz p2, :cond_0

    sget p2, Ll/ۙۦ۟ۥ;->ۨ۟ۛ:I

    goto :goto_0

    :cond_0
    sget p2, Ll/ۙۦ۟ۥ;->۠۟ۛ:I

    .line 1012
    :goto_0
    invoke-static {p0, p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->maybeApplyThemeDuration(Ll/ۖۗۜ;Landroid/content/Context;I)Z

    iget-boolean p2, p0, Lcom/google/android/material/transition/MaterialContainerTransform;->pathMotionCustom:Z

    if-nez p2, :cond_1

    sget p2, Ll/ۙۦ۟ۥ;->۠ۦۛ:I

    .line 1015
    invoke-static {p0, p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->maybeApplyThemePath(Ll/ۖۗۜ;Landroid/content/Context;I)Z
...
.method public captureEndValues(Ll/ۜۥ۟;)V
    ...
    .line 806
    invoke-static {p1, v0, v1, v2}, Lcom/google/android/material/transition/MaterialContainerTransform;->captureValues(Ll/ۜۥ۟;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Ll/ۜۥ۟;Ll/ۜۥ۟;)Landroid/animation/Animator;
    ...
    .line 892
    :cond_0
    iget-object v3, v0, Ll/ۜۥ۟;->ۛ:Ljava/util/HashMap;
    ...
    .line 900
    :cond_1
    iget-object v3, v1, Ll/ۜۥ۟;->ۛ:Ljava/util/HashMap;
    ...
    .line 908
    :cond_2
    iget-object v4, v0, Ll/ۜۥ۟;->۬:Landroid/view/View;

    .line 909
    iget-object v5, v1, Ll/ۜۥ۟;->۬:Landroid/view/View;
    ...
    invoke-virtual {v6, v8}, Ll/ۖۗۜ;->addListener(Ll/ۘۗۜ;)Ll/ۖۗۜ;
