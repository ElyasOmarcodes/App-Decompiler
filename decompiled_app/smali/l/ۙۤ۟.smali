...
# instance fields
.field public ۛ:Ll/ۨۚ۟;

.field public final ۜ:Ljava/util/LinkedHashMap;

.field public final ۥ:Ljava/util/LinkedHashMap;

.field public final ۨ:Ll/ۚۤ۟;

.field public final ۬:Landroidx/window/sidecar/SidecarInterface;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 63
    invoke-static {p1}, Ll/ۤۤ۟;->ۥ(Landroid/content/Context;)Landroidx/window/sidecar/SidecarInterface;
    ...
    invoke-direct {v0, v1}, Ll/ۚۤ۟;-><init>(I)V

    .line 49
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll/ۙۤ۟;->۬:Landroidx/window/sidecar/SidecarInterface;

    iput-object v0, p0, Ll/ۙۤ۟;->ۨ:Ll/ۚۤ۟;
    ...
    iput-object p1, p0, Ll/ۙۤ۟;->ۜ:Ljava/util/LinkedHashMap;
    ...
    iput-object p1, p0, Ll/ۙۤ۟;->ۥ:Ljava/util/LinkedHashMap;

    return-void
.end method

.method public static final synthetic ۛ(Ll/ۙۤ۟;)Ll/ۚۤ۟;
    .locals 0

    .line 49
    iget-object p0, p0, Ll/ۙۤ۟;->ۨ:Ll/ۚۤ۟;

    return-object p0
.end method

.method public static final synthetic ۥ(Ll/ۙۤ۟;)Ll/ۨۚ۟;
    .locals 0

    .line 49
    iget-object p0, p0, Ll/ۙۤ۟;->ۛ:Ll/ۨۚ۟;

    return-object p0
.end method

.method public static final synthetic ۬(Ll/ۙۤ۟;)Ljava/util/LinkedHashMap;
    .locals 0

    .line 49
    iget-object p0, p0, Ll/ۙۤ۟;->ۜ:Ljava/util/LinkedHashMap;
...
# virtual methods
.method public final ۛ(Landroid/app/Activity;)V
    .locals 4
    ...
    .line 139
    invoke-static {p1}, Ll/ۤۤ۟;->ۥ(Landroid/app/Activity;)Landroid/os/IBinder;
    ...
    :cond_0
    iget-object v1, p0, Ll/ۙۤ۟;->۬:Landroidx/window/sidecar/SidecarInterface;
    ...
    :goto_0
    iget-object v2, p0, Ll/ۙۤ۟;->ۥ:Ljava/util/LinkedHashMap;
    ...
    iget-object p1, p0, Ll/ۙۤ۟;->ۜ:Ljava/util/LinkedHashMap;
...
.method public final ۛ()Z
    ...
    .line 164
    invoke-static {v1, v4}, Ll/ۛ۫ۛۛ;->ۥ(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v6}, Ll/ۛ۫ۛۛ;->ۥ(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 281
    invoke-static {v4, v1}, Ll/ۛ۫ۛۛ;->ۥ(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 207
    invoke-static {v3, v2}, Ll/ۛ۫ۛۛ;->ۥ(Ljava/io/Serializable;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 195
    invoke-static {v1, v3}, Ll/ۛ۫ۛۛ;->ۥ(Ljava/io/Serializable;Ljava/lang/String;)Ljava/lang/String;
...
.method public final ۥ()Landroidx/window/sidecar/SidecarInterface;
    .locals 1

    .line 0
    iget-object v0, p0, Ll/ۙۤ۟;->۬:Landroidx/window/sidecar/SidecarInterface;
...
.method public final ۥ(Landroid/app/Activity;)V
    ...
    .line 90
    invoke-virtual {p0, v0, p1}, Ll/ۙۤ۟;->ۥ(Landroid/os/IBinder;Landroid/app/Activity;)V

    goto :goto_0

    .line 92
    :cond_0
    new-instance v0, Ll/ۖۤ۟;

    invoke-direct {v0, p0, p1}, Ll/ۖۤ۟;-><init>(Ll/ۙۤ۟;Landroid/app/Activity;)V
...
.method public final ۥ(Landroid/os/IBinder;Landroid/app/Activity;)V
    .locals 2
    ...
    .line 7
    iget-object v0, p0, Ll/ۙۤ۟;->ۜ:Ljava/util/LinkedHashMap;
    ...
    :cond_2
    :goto_1
    iget-object p1, p0, Ll/ۙۤ۟;->ۛ:Ll/ۨۚ۟;
    ...
    .line 111
    :cond_3
    invoke-virtual {p0, p2}, Ll/ۙۤ۟;->۬(Landroid/app/Activity;)Ll/۠۠۟;

    move-result-object v0

    check-cast p1, Ll/۠ۤ۟;

    invoke-virtual {p1, p2, v0}, Ll/۠ۤ۟;->ۥ(Landroid/app/Activity;Ll/۠۠۟;)V

    :goto_2
    iget-object p1, p0, Ll/ۙۤ۟;->ۥ:Ljava/util/LinkedHashMap;
    ...
    .line 121
    new-instance v0, Ll/ۡۤ۟;

    invoke-direct {v0, p0, p2}, Ll/ۡۤ۟;-><init>(Ll/ۙۤ۟;Landroid/app/Activity;)V
...
.method public final ۥ(Ll/۫ۤ۟;)V
    .locals 3

    .line 68
    new-instance v0, Ll/۠ۤ۟;

    invoke-direct {v0, p1}, Ll/۠ۤ۟;-><init>(Ll/۫ۤ۟;)V

    iput-object v0, p0, Ll/ۙۤ۟;->ۛ:Ll/ۨۚ۟;

    iget-object p1, p0, Ll/ۙۤ۟;->۬:Landroidx/window/sidecar/SidecarInterface;
    ...
    .line 70
    :cond_0
    new-instance v0, Ll/ۘۤ۟;

    .line 72
    new-instance v1, Ll/ۧۤ۟;

    invoke-direct {v1, p0}, Ll/ۧۤ۟;-><init>(Ll/ۙۤ۟;)V

    check-cast v1, Landroidx/window/sidecar/SidecarInterface$SidecarCallback;

    iget-object v2, p0, Ll/ۙۤ۟;->ۨ:Ll/ۚۤ۟;

    .line 70
    invoke-direct {v0, v2, v1}, Ll/ۘۤ۟;-><init>(Ll/ۚۤ۟;Landroidx/window/sidecar/SidecarInterface$SidecarCallback;)V
...
.method public final ۬(Landroid/app/Activity;)Ll/۠۠۟;
    .locals 2
    ...
    invoke-direct {p1, v0}, Ll/۠۠۟;-><init>(Ljava/util/List;)V
    ...
    :cond_3
    iget-object v1, p0, Ll/ۙۤ۟;->ۨ:Ll/ۚۤ۟;

    .line 81
    invoke-virtual {v1, p1, v0}, Ll/ۚۤ۟;->ۥ(Landroidx/window/sidecar/SidecarWindowLayoutInfo;Landroidx/window/sidecar/SidecarDeviceState;)Ll/۠۠۟;
