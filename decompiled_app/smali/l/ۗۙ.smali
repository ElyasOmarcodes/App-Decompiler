...
.field public final ۟:Landroid/widget/CompoundButton;
...
.method public constructor <init>(Landroid/widget/CompoundButton;)V
    ...
    iput-object v0, p0, Ll/ۗۙ;->ۥ:Landroid/content/res/ColorStateList;

    iput-object v0, p0, Ll/ۗۙ;->ۛ:Landroid/graphics/PorterDuff$Mode;

    const/4 v0, 0x0

    iput-boolean v0, p0, Ll/ۗۙ;->۬:Z

    iput-boolean v0, p0, Ll/ۗۙ;->ۨ:Z

    iput-object p1, p0, Ll/ۗۙ;->۟:Landroid/widget/CompoundButton;
...
.method public final ۛ()Landroid/content/res/ColorStateList;
    ...
    .line 0
    iget-object v0, p0, Ll/ۗۙ;->ۥ:Landroid/content/res/ColorStateList;
...
.method public final ۥ()V
    ...
    .line 2
    iget-object v0, p0, Ll/ۗۙ;->۟:Landroid/widget/CompoundButton;

    .line 127
    invoke-static {v0}, Ll/ۨۖ۬;->ۥ(Landroid/widget/CompoundButton;)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_4

    iget-boolean v2, p0, Ll/ۗۙ;->۬:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Ll/ۗۙ;->ۨ:Z
    ...
    iget-object v2, p0, Ll/ۗۙ;->ۥ:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, p0, Ll/ۗۙ;->ۛ:Landroid/graphics/PorterDuff$Mode;
...
.method public final ۥ(Landroid/content/res/ColorStateList;)V
    ...
    .line 2
    iput-object p1, p0, Ll/ۗۙ;->ۥ:Landroid/content/res/ColorStateList;

    const/4 p1, 0x1

    .line 5
    iput-boolean p1, p0, Ll/ۗۙ;->۬:Z

    .line 98
    invoke-virtual {p0}, Ll/ۗۙ;->ۥ()V
...
.method public final ۥ(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 2
    iput-object p1, p0, Ll/ۗۙ;->ۛ:Landroid/graphics/PorterDuff$Mode;

    const/4 p1, 0x1

    .line 5
    iput-boolean p1, p0, Ll/ۗۙ;->ۨ:Z
...
.method public final ۥ(Landroid/util/AttributeSet;I)V
    ...
    .line 2
    iget-object v6, p0, Ll/ۗۙ;->۟:Landroid/widget/CompoundButton;
    ...
    .line 80
    invoke-static {v6, p1}, Ll/ۨۖ۬;->ۥ(Landroid/widget/CompoundButton;Landroid/content/res/ColorStateList;)V
    ...
    .line 84
    invoke-static {v6, p1}, Ll/ۨۖ۬;->ۥ(Landroid/widget/CompoundButton;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_2
...
.method public final ۬()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 0
    iget-object v0, p0, Ll/ۗۙ;->ۛ:Landroid/graphics/PorterDuff$Mode;
