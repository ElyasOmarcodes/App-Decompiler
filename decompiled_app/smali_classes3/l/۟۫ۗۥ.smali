...
.method public bridge synthetic forEachRemaining(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Ll/۟۫ۗۥ;->forEachRemaining(Ljava/util/function/DoubleConsumer;)V
...
.method public forEachRemaining(Ljava/util/function/DoubleConsumer;)V
    ...
    new-instance v1, Ll/ۜ۫ۗۥ;

    invoke-direct {v1, p1}, Ll/ۜ۫ۗۥ;-><init>(Ljava/util/function/DoubleConsumer;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, Ll/۟۫ۗۥ;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
...
.method public initPartialTraversalState()V
    ...
    new-instance v0, Ll/ۤۡۗۥ;

    invoke-direct {v0}, Ll/ۤۡۗۥ;-><init>()V
    ...
    new-instance v2, Ll/۬۫ۗۥ;

    invoke-direct {v2, v0}, Ll/۬۫ۗۥ;-><init>(Ll/ۤۡۗۥ;)V
    ...
    new-instance v0, Ll/ۨ۫ۗۥ;

    invoke-direct {v0, p0}, Ll/ۨ۫ۗۥ;-><init>(Ll/۟۫ۗۥ;)V
...
.method public synthetic lambda$initPartialTraversalState$0$java-util-stream-StreamSpliterators$DoubleWrappingSpliterator()Z
    .locals 2
...
.method public tryAdvance(Ljava/util/function/DoubleConsumer;)Z
    ...
    check-cast v1, Ll/ۤۡۗۥ;

    iget-wide v2, p0, Ll/ۦۙۗۥ;->nextToConsume:J

    invoke-virtual {v1, v2, v3}, Ll/ۤۡۗۥ;->get(J)D
...
.method public bridge synthetic trySplit()Ll/ۦۜۢۥ;
    ...
    invoke-virtual {p0}, Ll/۟۫ۗۥ;->trySplit()Ll/ۘۨۢۥ;
...
.method public wrap(Ll/ۦۜۢۥ;)Ll/ۦۙۗۥ;
    ...
    invoke-direct {v0, v1, p1, v2}, Ll/۟۫ۗۥ;-><init>(Ll/ۛۚۗۥ;Ll/ۦۜۢۥ;Z)V
