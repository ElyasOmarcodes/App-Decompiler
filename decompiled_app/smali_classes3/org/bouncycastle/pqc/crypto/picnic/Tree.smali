...
.method private getRevealedNodes([II[I)[I
    ...
    iget v6, p0, Lorg/bouncycastle/pqc/crypto/picnic/Tree;->numLeaves:I
    ...
    invoke-direct {p0, v6}, Lorg/bouncycastle/pqc/crypto/picnic/Tree;->hasSibling(I)Z
    ...
    invoke-direct {p0, v6}, Lorg/bouncycastle/pqc/crypto/picnic/Tree;->getSibling(I)I

    move-result v6

    aget-object v7, v1, v3

    invoke-direct {p0, v7, p2, v6}, Lorg/bouncycastle/pqc/crypto/picnic/Tree;->contains([III)Z
    ...
    :goto_4
    invoke-direct {p0, v6}, Lorg/bouncycastle/pqc/crypto/picnic/Tree;->hasRightChild(I)Z

    move-result v7

    if-nez v7, :cond_3

    invoke-direct {p0, v6}, Lorg/bouncycastle/pqc/crypto/picnic/Tree;->isLeafNode(I)Z
    ...
    :cond_3
    invoke-direct {p0, p1, v4, v6}, Lorg/bouncycastle/pqc/crypto/picnic/Tree;->contains([III)Z
