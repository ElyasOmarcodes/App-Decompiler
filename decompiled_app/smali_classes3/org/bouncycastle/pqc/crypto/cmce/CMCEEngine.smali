...
.method public static cbrecursion([BJJ[SIJJ[I)V
    ...
    invoke-static {v12, v3, v4}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->sort32([III)V
    ...
    invoke-static {v12, v3, v2}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->sort32([III)V
    ...
    invoke-static {v12, v0, v1}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->sort32([III)V
...
.method public static controlbitsfrompermutation([B[SJJ)V
    ...
    invoke-static {v2, v3, v1, v0, v4}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->layer([S[BIII)V
...
.method private mov_columns([[B[S[J)I
    ...
    :cond_5
    invoke-static/range {v16 .. v17}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->ctz(J)I
    ...
    invoke-static {v11, v2}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->same_mask64(SS)J
    ...
    invoke-static {v6, v2}, Lorg/bouncycastle/pqc/crypto/cmce/Utils;->load8([BI)J
    ...
    invoke-static {v2, v8}, Lorg/bouncycastle/pqc/crypto/cmce/Utils;->load8([BI)J
    ...
    invoke-static {v6, v2, v4, v5}, Lorg/bouncycastle/pqc/crypto/cmce/Utils;->store8([BIJ)V
    ...
    invoke-static {v2, v8, v4, v5}, Lorg/bouncycastle/pqc/crypto/cmce/Utils;->store8([BIJ)V
...
.method private pk_gen([B[B[I[S[J)I
    ...
    iget-object v10, v0, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->gf:Lorg/bouncycastle/pqc/crypto/cmce/GF;

    aget-short v11, v7, v8

    aget-short v12, v6, v8

    invoke-virtual {v10, v11, v12}, Lorg/bouncycastle/pqc/crypto/cmce/GF;->gf_mul(SS)S
    ...
    invoke-direct {v0, v4, v2, v10}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->mov_columns([[B[S[J)I
...
.method public kem_keypair([B[BLjava/security/SecureRandom;)V
    ...
    :goto_0
    invoke-interface {v14, v9, v3, v8}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    array-length v4, v1

    invoke-interface {v14, v1, v3, v4}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-interface {v14, v12, v3, v11}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
    ...
    invoke-static {v15, v3, v0}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
