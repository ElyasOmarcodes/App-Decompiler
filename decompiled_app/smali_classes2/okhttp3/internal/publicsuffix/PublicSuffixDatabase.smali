...
.method public static binarySearchBytes([B[[BI)Ljava/lang/String;
    ...
    sget-object p2, Ll/ۤۛۨۛ;->ۙ:Ljava/nio/charset/Charset;
...
.method private readTheList()V
    ...
    .line 316
    :cond_0
    new-instance v1, Ll/۠ۚۨۛ;

    invoke-static {v0}, Ll/۫ۚۨۛ;->ۥ(Ljava/io/InputStream;)Ll/۠ۤۨۛ;

    move-result-object v0

    invoke-direct {v1, v0}, Ll/۠ۚۨۛ;-><init>(Ll/۠ۤۨۛ;)V

    invoke-static {v1}, Ll/۫ۚۨۛ;->ۥ(Ll/۠ۤۨۛ;)Ll/ۜۚۨۛ;

    move-result-object v0

    .line 318
    :try_start_0
    invoke-interface {v0}, Ll/ۜۚۨۛ;->readInt()I
    ...
    .line 320
    invoke-interface {v0, v1}, Ll/ۜۚۨۛ;->readFully([B)V
    ...
    .line 324
    invoke-interface {v0, v2}, Ll/ۜۚۨۛ;->readFully([B)V
    :try_end_0
...
.method private readTheListUninterruptibly()V
    ...
    invoke-virtual {v2, v4, v3, v1}, Ll/ۚۦۨۛ;->ۥ(ILjava/lang/String;Ljava/lang/Throwable;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
