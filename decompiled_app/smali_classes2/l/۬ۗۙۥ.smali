.class public final synthetic Ll/۬ۗۙۥ;
.super Ll/ۜۗۙۥ;
.source "S66S"
...
# direct methods
.method public synthetic constructor <init>(Ljava/nio/file/FileStore;)V
    .locals 0

    invoke-direct {p0}, Ll/ۜۗۙۥ;-><init>()V

    iput-object p1, p0, Ll/۬ۗۙۥ;->wrappedValue:Ljava/nio/file/FileStore;

    return-void
.end method

.method public static synthetic convert(Ljava/nio/file/FileStore;)Ll/ۜۗۙۥ;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۨۗۙۥ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۨۗۙۥ;

    iget-object p0, p0, Ll/ۨۗۙۥ;->wrappedValue:Ll/ۜۗۙۥ;

    return-object p0

    :cond_1
    new-instance v0, Ll/۬ۗۙۥ;

    invoke-direct {v0, p0}, Ll/۬ۗۙۥ;-><init>(Ljava/nio/file/FileStore;)V
...
.method public synthetic equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Ll/۬ۗۙۥ;->wrappedValue:Ljava/nio/file/FileStore;

    instance-of v1, p1, Ll/۬ۗۙۥ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/۬ۗۙۥ;

    iget-object p1, p1, Ll/۬ۗۙۥ;->wrappedValue:Ljava/nio/file/FileStore;
...
.method public synthetic getFileStoreAttributeView(Ljava/lang/Class;)Ll/ۜۜ۫ۥ;
    .locals 1
    ...
    invoke-static {p1}, Ll/۬ۜ۫ۥ;->convert(Ljava/nio/file/attribute/FileStoreAttributeView;)Ll/ۜۜ۫ۥ;
