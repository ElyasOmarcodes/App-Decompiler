.class public final synthetic Ll/۫۬۫ۥ;
...
# instance fields
.field public final synthetic wrappedValue:Ll/ۢ۬۫ۥ;


# direct methods
.method public synthetic constructor <init>(Ll/ۢ۬۫ۥ;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll/۫۬۫ۥ;->wrappedValue:Ll/ۢ۬۫ۥ;

    return-void
.end method

.method public static synthetic convert(Ll/ۢ۬۫ۥ;)Ljava/nio/file/attribute/BasicFileAttributeView;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۙ۬۫ۥ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۙ۬۫ۥ;

    iget-object p0, p0, Ll/ۙ۬۫ۥ;->wrappedValue:Ljava/nio/file/attribute/BasicFileAttributeView;

    return-object p0

    :cond_1
    instance-of v0, p0, Ll/ۜۨ۫ۥ;

    if-eqz v0, :cond_2

    check-cast p0, Ll/ۜۨ۫ۥ;

    invoke-static {p0}, Ll/ۨۨ۫ۥ;->convert(Ll/ۜۨ۫ۥ;)Ljava/nio/file/attribute/DosFileAttributeView;
    ...
    :cond_3
    new-instance v0, Ll/۫۬۫ۥ;

    invoke-direct {v0, p0}, Ll/۫۬۫ۥ;-><init>(Ll/ۢ۬۫ۥ;)V
...
.method public synthetic equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Ll/۫۬۫ۥ;->wrappedValue:Ll/ۢ۬۫ۥ;

    instance-of v1, p1, Ll/۫۬۫ۥ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/۫۬۫ۥ;

    iget-object p1, p1, Ll/۫۬۫ۥ;->wrappedValue:Ll/ۢ۬۫ۥ;
...
.method public synthetic name()Ljava/lang/String;
    ...
    invoke-interface {v0}, Ll/ۢ۬۫ۥ;->name()Ljava/lang/String;
