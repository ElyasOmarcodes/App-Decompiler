.class public final synthetic Ll/ۢ۠ۢۥ;
...
.method public synthetic constructor <init>(Ljava/util/stream/BaseStream;)V
    ...
    iput-object p1, p0, Ll/ۢ۠ۢۥ;->wrappedValue:Ljava/util/stream/BaseStream;

    return-void
.end method

.method public static synthetic convert(Ljava/util/stream/BaseStream;)Ll/ۥۘۢۥ;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۗ۠ۢۥ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۗ۠ۢۥ;

    iget-object p0, p0, Ll/ۗ۠ۢۥ;->wrappedValue:Ll/ۥۘۢۥ;
    ...
    invoke-static {p0}, Ll/ۡۡۢۥ;->convert(Ljava/util/stream/DoubleStream;)Ll/۫ۡۢۥ;
    ...
    invoke-static {p0}, Ll/ۧۛۗۥ;->convert(Ljava/util/stream/LongStream;)Ll/ۙۛۗۥ;
    ...
    invoke-static {p0}, Ll/ۢۡۗۥ;->convert(Ljava/util/stream/Stream;)Ll/ۥۙۗۥ;
    ...
    :cond_5
    new-instance v0, Ll/ۢ۠ۢۥ;

    invoke-direct {v0, p0}, Ll/ۢ۠ۢۥ;-><init>(Ljava/util/stream/BaseStream;)V
...
.method public synthetic close()V
    ...
    iget-object v0, p0, Ll/ۢ۠ۢۥ;->wrappedValue:Ljava/util/stream/BaseStream;
...
.method public synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/ۢ۠ۢۥ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/ۢ۠ۢۥ;

    iget-object p1, p1, Ll/ۢ۠ۢۥ;->wrappedValue:Ljava/util/stream/BaseStream;
