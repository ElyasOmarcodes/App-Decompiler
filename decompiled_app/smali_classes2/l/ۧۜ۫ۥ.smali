.class public final synthetic Ll/ۧۜ۫ۥ;
...
.method public synthetic constructor <init>(Ljava/nio/file/attribute/PosixFileAttributeView;)V
    ...
    iput-object p1, p0, Ll/ۧۜ۫ۥ;->wrappedValue:Ljava/nio/file/attribute/PosixFileAttributeView;

    return-void
.end method

.method public static synthetic convert(Ljava/nio/file/attribute/PosixFileAttributeView;)Ll/ۙۜ۫ۥ;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/ۡۜ۫ۥ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/ۡۜ۫ۥ;

    iget-object p0, p0, Ll/ۡۜ۫ۥ;->wrappedValue:Ll/ۙۜ۫ۥ;

    return-object p0

    :cond_1
    new-instance v0, Ll/ۧۜ۫ۥ;

    invoke-direct {v0, p0}, Ll/ۧۜ۫ۥ;-><init>(Ljava/nio/file/attribute/PosixFileAttributeView;)V
...
.method public synthetic equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Ll/ۧۜ۫ۥ;->wrappedValue:Ljava/nio/file/attribute/PosixFileAttributeView;

    instance-of v1, p1, Ll/ۧۜ۫ۥ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/ۧۜ۫ۥ;

    iget-object p1, p1, Ll/ۧۜ۫ۥ;->wrappedValue:Ljava/nio/file/attribute/PosixFileAttributeView;
...
.method public synthetic readAttributes()Ll/ۗۜ۫ۥ;
    .locals 1
    ...
    invoke-static {v0}, Ll/۫ۜ۫ۥ;->convert(Ljava/nio/file/attribute/PosixFileAttributes;)Ll/ۗۜ۫ۥ;
...
.method public synthetic setGroup(Ll/ۖۜ۫ۥ;)V
    .locals 1
