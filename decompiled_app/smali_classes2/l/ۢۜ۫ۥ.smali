.class public final synthetic Ll/ۢۜ۫ۥ;
...
# instance fields
.field public final synthetic wrappedValue:Ll/ۗۜ۫ۥ;


# direct methods
.method public synthetic constructor <init>(Ll/ۗۜ۫ۥ;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll/ۢۜ۫ۥ;->wrappedValue:Ll/ۗۜ۫ۥ;

    return-void
.end method

.method public static synthetic convert(Ll/ۗۜ۫ۥ;)Ljava/nio/file/attribute/PosixFileAttributes;
    .locals 1
    ...
    :cond_0
    instance-of v0, p0, Ll/۫ۜ۫ۥ;

    if-eqz v0, :cond_1

    check-cast p0, Ll/۫ۜ۫ۥ;

    iget-object p0, p0, Ll/۫ۜ۫ۥ;->wrappedValue:Ljava/nio/file/attribute/PosixFileAttributes;

    return-object p0

    :cond_1
    new-instance v0, Ll/ۢۜ۫ۥ;

    invoke-direct {v0, p0}, Ll/ۢۜ۫ۥ;-><init>(Ll/ۗۜ۫ۥ;)V
...
.method public synthetic creationTime()Ljava/nio/file/attribute/FileTime;
    ...
    iget-object v0, p0, Ll/ۢۜ۫ۥ;->wrappedValue:Ll/ۗۜ۫ۥ;
...
.method public synthetic equals(Ljava/lang/Object;)Z
    ...
    instance-of v1, p1, Ll/ۢۜ۫ۥ;

    if-eqz v1, :cond_0

    check-cast p1, Ll/ۢۜ۫ۥ;

    iget-object p1, p1, Ll/ۢۜ۫ۥ;->wrappedValue:Ll/ۗۜ۫ۥ;
...
.method public synthetic group()Ljava/nio/file/attribute/GroupPrincipal;
    ...
    invoke-interface {v0}, Ll/ۗۜ۫ۥ;->group()Ll/ۖۜ۫ۥ;

    move-result-object v0

    invoke-static {v0}, Ll/ۘۜ۫ۥ;->convert(Ll/ۖۜ۫ۥ;)Ljava/nio/file/attribute/GroupPrincipal;
...
.method public synthetic owner()Ljava/nio/file/attribute/UserPrincipal;
    ...
    invoke-interface {v0}, Ll/ۗۜ۫ۥ;->owner()Ll/ۚ۟۫ۥ;
...
.method public synthetic permissions()Ljava/util/Set;
    ...
    invoke-interface {v0}, Ll/ۗۜ۫ۥ;->permissions()Ljava/util/Set;
